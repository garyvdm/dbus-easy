...
There are currently two implementations of the message bus depending on what main loop implementation you want to use. Use :class:`aio.MessageBus <dbus_ezy.aio.MessageBus>` if you are using an asyncio main loop. Use :class:`glib.MessageBus <dbus_ezy.glib.MessageBus>` if you are using a GLib main loop.
